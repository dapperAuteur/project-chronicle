  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="mb-4">
          <label className="block mb-2 text-white">Change Email (Current: {user.email})</label>
          <input
            type="email"
            value={newEmail}
        ...
        <div className="mb-4">
          <label className="block mb-2 text-white">Change Password</label>
          <input
            type="password"
            value={newPassword}
        ...
        <div className="border-t border-gray-700 pt-4 mt-4">
          <label className="block mb-2 text-red-500">Danger Zone</label>
